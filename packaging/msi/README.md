# ringlet (Windows MSI Installer)

[![Windows installer](https://img.shields.io/badge/windows-MSI-blue.svg)](https://github.com/neul-labs/ringlet/releases)
...
Download the latest `.msi` from the [releases page](https://github.com/neul-labs/ringlet/releases) and double-click to install, or run from PowerShell:

```powershell
msiexec /i ringlet-x64.msi /quiet
```
