# ringlet (Arch Linux / AUR)

[![AUR version](https://img.shields.io/aur/version/ringlet)](https://aur.archlinux.org/packages/ringlet)
...
```bash
git clone https://aur.archlinux.org/ringlet.git
cd ringlet
makepkg -si
```
