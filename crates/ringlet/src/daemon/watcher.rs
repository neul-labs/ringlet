...
//!
//! This module watches:
//! - ~/.config/ringlet/agents.d/ for new/updated agent manifests
//! - ~/.config/ringlet/providers.d/ for new/updated provider manifests
//! - ~/.config/ringlet/profiles/ for profile changes
