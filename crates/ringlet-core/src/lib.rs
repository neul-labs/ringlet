//! Core types and utilities for the ringlet CLI orchestrator.
//!
//! This crate provides shared types used by both the CLI (`ringlet`) and
//! the daemon (`ringletd`), including:
//!
...
/// Application name.
pub const APP_NAME: &str = "ringlet";

/// Daemon name.
pub const DAEMON_NAME: &str = "ringletd";
